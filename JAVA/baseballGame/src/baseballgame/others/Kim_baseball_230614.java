...
public class Kim_baseball_230614 {
...
//몇번만에 난수가 생성되는지 확인
                randomCnt++;
//1~9사이의 난수생성
                com1 = random.nextInt(10) + 1; // 작성자는 100 % 9 + 1 을 했는데 왜인지 모르겠어요.
                com2 = random.nextInt(10) + 1;
                com3 = random.nextInt(10) + 1;
                if (!(com1 == com2 || com2 == com3 || com3 == com1)) {
//중복되지 않는 난수 생성에 성공하면 루프탈출 서로 중복 안되면? 탈출해라 이거인듯?
                    break;
                }
            }////while end
