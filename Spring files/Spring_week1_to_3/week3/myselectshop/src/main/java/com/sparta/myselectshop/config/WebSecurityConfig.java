...
public class WebSecurityConfig {
    ...
    private final AuthenticationConfiguration authenticationConfiguration; // Authentication Manager를 만든다
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 필터 관리
        http.addFilterBefore(jwtAuthorizationFilter(), JwtAuthenticationFilter.class); // 인증필터 앞에 토큰 검사하는 인가필터둠
