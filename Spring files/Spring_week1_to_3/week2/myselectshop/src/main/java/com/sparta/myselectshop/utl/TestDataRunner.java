package com.sparta.myselectshop.utl;
...
@Component
//public class TestDataRunner implements ApplicationRunner {  //  ApplicationRunner: 프로그램이 동작할때 같이 실행됨
public class TestDataRunner {
    ...
    @Autowired
    com.sparta.myselectshop.naver.service.NaverApiService naverApiService;
