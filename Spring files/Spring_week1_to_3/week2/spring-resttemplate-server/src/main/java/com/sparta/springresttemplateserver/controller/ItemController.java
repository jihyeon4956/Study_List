...
public class ItemController { // 포스트맨의 요청을 받는게 아니라 클라이언트 입장의 서버에서 보내온 RestTemplate 요청을 받는 컨트롤러다
    ...
    public Item getCallObject(@RequestParam String query) { // @RequestParam: client에서 ?로 넘어오게 만들었음
